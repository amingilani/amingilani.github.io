    ...
    <section className="hero is-warning is-medium">
      <div className="hero-body">
        <div className="container has-text-centered">
          ...
          <h1 className="title">
            Save Pakistan's Games
          </h1>

          <h2 className="subtitle">
            <strong>PTA has banned PUBG for unwise reasons, take action to save our freedom</strong>
          </h2>
    ...
    <section class="section">
      <div className="columns">
        <div className="column is-6 is-offset-3">
          ...
          <p>PTA has temporarily suspended PUBG citing concerns that it is:
          <ol>
            <li>"addictive",</li>
            <li>a "wastage of time"; and</li>
            <li>"poses [a] serious negative impact on physical and psychological health".</li>
          </ol>

          <blockquote class="twitter-tweet"><p lang="en" dir="ltr">PTA has received numerous complaints against PUBG wherein it is stated that the game is addictive, wastage of time and poses serious negative impact on physical and psychological health of the children. <a href="https://t.co/GDJqTeuTaf">pic.twitter.com/GDJqTeuTaf</a></p>&mdash; PTA (@PTAofficialpk) <a href="https://twitter.com/PTAofficialpk/status/1278324087459323905?ref_src=twsrc%5Etfw">July 1, 2020</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
          ...
          <h3>1. PUBG is not physically addictive</h3>
          <p>
          And addictive products are not banned. When away from PUBG, a person does not exhibit physical withdrawal symptoms. Furthermore, even if PUBG were addictive, addictive products, such as those containing nicotine are not banned in Pakistan.
          </p>

          <h3>2. Calling PUBG a waste of time is unwarranted</h3>
          <p>
          The idea that a form of entertainment is a &quot;wastage of time&quot; can apply to many similar items and activies such as television, sports, festivals, the circus, board games, cinema, film, dance, animals, magic shows, parades, firework, theatre, music, fiction books, every other game in work, and more.
          </p>

          <h3>3. Violent video games do not adversely affect mental health</h3>
          <p>
          This has been studied and concluded multiple times:
          </p>
          <ul>
          <li><a href="https://doi.org/10.1007/s10964-013-9986-5">Ferguson and Olson 2014</a> concluded that &quot;results did not support the hypothesis that children with elevated mental health symptoms constitute a 'vulnerable' population for video game violence effects&quot;.</li>
          <li>In another paper, <a href="https://doi.org/10.1016/j.chb.2015.04.021">Ferguson et al. 2015</a> further concluded that &quot;youth with prior mental health symptoms were no more influenced by violent games&quot; and &quot;parental restrictions on gaming were not associated with positive outcomes&quot;.</li>
          <li>Most importantly, in <a href="https://doi.org/10.1186/1471-2458-10-286">Allahverdipour et al. 2010</a>, a study in an Islamic country found positive impacts on mental health of moderate gaming, and negative impacts of not gaming at all&mdash;which is the strategy PTA is imposing. Their conclusions were that &quot;both children and parents of non-game players should be updated about the positive impact of moderate video gaming&quot;.</li>
          </ul>
          <p>
          The position PTA has adopted is contrary to researched facts.
          </p>
          ...
          <p>
          <strong> Even if you are not directly impacted by this ban, </strong>
          the reasons given are so vague and infactual that this will set a precendence for them to ban something you care about tomorrow.
          </p>
